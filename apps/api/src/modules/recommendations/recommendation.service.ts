  ...
  async generate(params: {
    ...
    try {
      ...
      const recommendation = await prisma.recommendation.create({
        data: {
          consensus: { connect: { alertId: params.alertId } },
          alert: { connect: { id: params.alertId } },
      ...
      const event = new RecommendationGeneratedEvent(
        ...
        params.consensusRecommendation,
        params.currentPrice,
        recommendation.targetPrice === null ? undefined : Number(recommendation.targetPrice),
        recommendation.stopLoss === null ? undefined : Number(recommendation.stopLoss),
      );
