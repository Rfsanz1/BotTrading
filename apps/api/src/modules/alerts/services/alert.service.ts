...
export class AlertService {
   ...
   */
  async handleWebhook(userId: string, payload: Record<string, any>, webhookSource: string, webhookId?: string): Promise<string> {
    try {
      ...
      if (!parsedData) {
        throw new WebhookValidationException('Webhook validation did not produce parsed data');
      }
