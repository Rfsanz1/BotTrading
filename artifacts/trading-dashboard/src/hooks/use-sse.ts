...
/**
 * The current backend does not expose an authenticated SSE endpoint. Keep
 * this hook available for a future canonical stream without inventing a URL.
 */
export function useSSE<T>(endpoint: string | null): SSEState<T> {
