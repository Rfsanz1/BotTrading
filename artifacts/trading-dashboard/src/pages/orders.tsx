...
export default function Orders() {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        const d = await apiFetch<any>(`/api/trading/orders/${selectedId}`);
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Order listing is not exposed by the current backend; no order data is fabricated.</p>
      </div>
