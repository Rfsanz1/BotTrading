...
export default function Risk() {
  ...
  const { data: positionsData } = useApiData<any[]>('/api/trading/positions/open');
  ...
  const saveSettings = async () => {
    try {
      toast.error('Risk settings are not exposed by the current backend; nothing was changed.');
    } catch (e: any) {
