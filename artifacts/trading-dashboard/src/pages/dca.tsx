...
export default function DCAManager() {
  ...
  const handleAdd = async (e: React.FormEvent) => {
    e.preventDefault();
    toast.error('DCA plans are not exposed by the current backend; no request was sent.');
  };
  ...
  const triggerBuy = async (symbol: string, amount: number) => {
    toast.error('DCA execution is not exposed by the current backend; no request was sent.');
  };
